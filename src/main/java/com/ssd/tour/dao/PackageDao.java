...
public class PackageDao {
	...
	public boolean updateBook(Packages packages) throws ClassNotFoundException, SQLException {
		if (packages != null) {
			Connection connection = Configs.getDbConnection();
			String sql = "UPDATE book SET package_name = ?, package_type = ?, package_amount = ?, package_desc=?";
